...
<required_reading>
@/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude
                  → checks /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done
                  → writes to /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/hooks/
...
@/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
