...
```bash
AUDITOR_MODEL=$(node "/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/agents/gsd-eval-auditor.md for instructions.
