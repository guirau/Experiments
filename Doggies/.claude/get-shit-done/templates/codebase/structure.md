...
- Usage: Reference from command with `@/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
