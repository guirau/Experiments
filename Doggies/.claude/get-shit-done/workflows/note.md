...
- **Global scope**: `/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/notes/`)
...
2. Glob `/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/guirau/GitHub/guirau/Experiments/Doggies/.claude/notes/` — works in any directory
